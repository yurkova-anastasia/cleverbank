...
class UserServiceImplTest {
    ...
    class UpdateById {
        ...
        void updateByIdTest_shouldReturnTrueInCaseOfSuccessfulUpdate() {
            ...
            boolean actual = userService.updateById(id, requestDto);
        ...
        @Test
        void updateByIdTest_shouldThrowExceptionIfUserIsNotFound() {
            //given
            Long id = 3L;
            LocalDate now = LocalDate.now();
            UserRequestDto requestDto = new UserRequestDto("Nastya", "Yurkova", now);
            ...
            //then
            Assertions.assertThrows(EntityNotFoundException.class, () -> userService.updateById(id, requestDto));
        }
    }
    ...
    class DeleteById {
        ...
        @Test
        void deleteByIdTest_shouldDeleteUserWithId3() {
            //given
            Long id = 3L;
            LocalDate now = LocalDate.now();
            User userWithId = new User("Nastya", "Yurkova", now, true);
            ...
            boolean actual = userService.deleteById(id);
        ...
        @Test
        void deleteByIdTest_shouldThrowExceptionIfUserIsNotFound() {
            //given
            Long id = 3L;
