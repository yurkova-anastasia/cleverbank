...
class BankServiceImplTest {
    ...
    class UpdateById {
        ...
        @Test
        void updateByIdTest_shouldReturnTrueInCaseOfSuccessfulUpdate() {
            //given
            Long id = 3L;
            ...
            boolean actual = bankService.updateById(id, requestDto);
        ...
        @Test
        void updateByIdTest_shouldThrowExceptionIfBankIsNotFound() {
            //given
            Long id = 3L;
            BankRequestDto requestDto = new BankRequestDto("NEWBank");
            ...
            //then
            Assertions.assertThrows(EntityNotFoundException.class, () -> bankService.updateById(id, requestDto));
        }
    }
    ...
    class DeleteById {
        ...
        @Test
        void deleteByIdTest_shouldDeleteBankWithId3() {
            //given
            Long id = 3L;
            Bank bankWithId = new Bank("Bank", true);
            bankWithId.setId(id);
            ...
            boolean actual = bankService.deleteById(id);
        ...
        @Test
        void deleteByIdTest_shouldThrowExceptionIfBankIsNotFound() {
            //given
            Long id = 3L;
            ...
            //then
            Assertions.assertThrows(EntityNotFoundException.class, () -> bankService.deleteById(id));
