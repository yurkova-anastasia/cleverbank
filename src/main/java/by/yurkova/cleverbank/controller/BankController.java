...
public class BankController extends HttpServlet {
    ...
    public void init(ServletConfig config) {
        this.bankService = AppConfig.getBankService();
    ...
    protected void doPut(
        ...
        bankService.updateById(Long.parseLong(id), bankRequestDto);
    ...
    protected void doDelete(
        ...
        validateRequestURIWithId(req);
        String[] partsOfURI = req.getRequestURI().split("/");
        boolean result = bankService.deleteById(Long.parseLong(partsOfURI[2]));
        resp.setStatus(204);
        writer.print(result);
        writer.close();
    }
